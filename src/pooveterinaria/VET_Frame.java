 ...
 * @author Usuario
 */
public class VET_Frame extends javax.swing.JFrame {
    ...
    VET_Demo DEM = new VET_Demo();
    // Register the JDBC driver


// Create the connection
    // SQL: USER = 'vet' PSWD = '123456789'
    /**
    ...
    private void initComponents() {
        ...
        jLabel1.setText("VETERINARIA PATITAS");
    ...
    private void BtnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGuardarActionPerformed
        try {
            ...
            Logger.getLogger(VET_Frame.class.getName()).log(Level.SEVERE, null, ex);
        }
   ...
   // TENER EN CUENTA DURANTE CLASE: https://youtu.be/hTGWH09rMQM?si=bqo5OeaIgDryHHY_&t=1279
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VET_Frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
